...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="relative bg-gradient-to-b from-white to-neutral-50 pt-24 pb-12 overflow-hidden">
          ...
          <div className="flex justify-center space-x-4 mb-12">
            {socialLinks.map((link, index) => (
              ...
              >
                ...
                <div className={`relative w-14 h-14 bg-white rounded-2xl shadow-lg flex items-center justify-center transition-all duration-300 group-hover:shadow-xl ${link.color} group-hover:text-white`}>
                  <link.icon size={24} />
                </div>
            ...
            >
              <div className="absolute inset-0 bg-accent/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
              <div className="relative w-14 h-14 bg-white rounded-2xl shadow-lg flex items-center justify-center transition-all duration-300 group-hover:shadow-xl hover:bg-green-500">
                <Image
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            ...
            <div className="text-left">
              <p className="text-neutral-700 font-medium">Created with passion by Yuzu</p>
          ...
          <motion.button
            ...
            viewport={{ once: true }}
            whileHover={{ y: -5 }}
            className="group flex items-center px-6 py-3 bg-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
          >
